...
// NASA GISTEMP annual global mean surface temperature anomaly (°C, base 1951–1980)
const GISTEMP: [number, number][] = [
  [1880,-0.16],[1881,-0.08],[1882,-0.11],[1883,-0.17],[1884,-0.28],
  [1885,-0.33],[1886,-0.31],[1887,-0.36],[1888,-0.17],[1889,-0.10],
  ...
  [1925,-0.20],[1926,-0.06],[1927,-0.19],[1928,-0.22],[1929,-0.36],
  [1930,-0.09],[1931,-0.07],[1932,-0.11],[1933,-0.26],[1934,-0.16],
...
const temperatureStory: Story = {
  ...
  events: GISTEMP.map(([year, value]) => ({
    id: `temp-${year}`,
    title: `${year}`,
    description: `Global mean temperature anomaly: ${value >= 0 ? '+' : ''}${value.toFixed(2)}°C vs 1951–1980 average`,
    timestamp: `${year}-07-01T00:00:00Z`,
    category: 'temperature',
    value,
  })),
};

export { temperatureStory };